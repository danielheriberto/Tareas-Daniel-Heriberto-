...
```{python}
df_inegi = pd.read_excel("C:/Users/danie/Documents/Analisis Numérico/inegi_subdata.xlsx")
...
# Modelo: Actividades Primarias \~ Actividades Industriales
...
```{python}
plt.figure()
sns.regplot(x="Actividad_Industrial", y="Actividades_Primarias", data=df_inegi, color="maroon", line_kws={"color":"black"})
plt.title("Actividades Primarias vs Actividad_Industrial")
plt.xlabel("Actividad_Industrial")
...
```{python}
acciones_df = pd.read_excel("C:/Users/danie/Documents/Analisis Numérico/Acciones Daniel H. T.3.xlsx")
...
# Regresión: Netflix vs Microsoft
...
plt.figure()
sns.regplot(x="Microsoft.Close", y="Netflix.Close", data=acciones_df, color="forestgreen", line_kws={"color":"red"})
plt.title("Netflix vs Microsoft.Close)
plt.tight_layout()
plt.show()
```

# Regresión: Amazon vs Apple
...
plt.figure()
sns.regplot(x="Apple.Close", y="Amazon.Close", data=acciones_df, color="indigo", line_kws={"color":"goldenrod"})
plt.title("Amazon vs Apple.Close")
plt.tight_layout()
plt.show()
```
